  ...
  internal = rec {
    ...
    crates = {
      ...
      "andro" = rec {
        ...
        src = lib.cleanSourceWith { filter = sourceFilter;  src = ./crates/andro; };
        authors = [
          "pleme-io"
        ];
        dependencies = [
      ...
      "andro-adb" = rec {
        ...
        version = "0.1.0";
        edition = "2024";
        src = lib.cleanSourceWith { filter = sourceFilter;  src = ./crates/andro-adb; };
        libName = "andro_adb";
        authors = [
          "pleme-io"
        ];
      ...
      "andro-axml" = rec {
        crateName = "andro-axml";
        version = "0.1.0";
        edition = "2024";
        src = lib.cleanSourceWith { filter = sourceFilter;  src = ./crates/andro-axml; };
        libName = "andro_axml";
        authors = [
          "pleme-io"
        ];
      ...
      "andro-build" = rec {
        crateName = "andro-build";
        version = "0.1.0";
        edition = "2024";
        src = lib.cleanSourceWith { filter = sourceFilter;  src = ./crates/andro-build; };
        libName = "andro_build";
        authors = [
          "pleme-io"
        ];
      ...
      "andro-core" = rec {
        crateName = "andro-core";
        version = "0.1.0";
        edition = "2024";
        src = lib.cleanSourceWith { filter = sourceFilter;  src = ./crates/andro-core; };
        libName = "andro_core";
        authors = [
          "pleme-io"
        ];
      ...
      "andro-dex" = rec {
        ...
        version = "0.1.0";
        edition = "2024";
        src = lib.cleanSourceWith { filter = sourceFilter;  src = ./crates/andro-dex; };
        libName = "andro_dex";
        authors = [
          "pleme-io"
        ];
      ...
      "andro-farm" = rec {
        crateName = "andro-farm";
        version = "0.1.0";
        edition = "2024";
        src = lib.cleanSourceWith { filter = sourceFilter;  src = ./crates/andro-farm; };
        libName = "andro_farm";
        authors = [
          "pleme-io"
        ];
      ...
      "andro-fleet" = rec {
        crateName = "andro-fleet";
        version = "0.1.0";
        edition = "2024";
        src = lib.cleanSourceWith { filter = sourceFilter;  src = ./crates/andro-fleet; };
        libName = "andro_fleet";
        authors = [
          "pleme-io"
        ];
      ...
      "andro-gos" = rec {
        ...
        version = "0.1.0";
        edition = "2024";
        src = lib.cleanSourceWith { filter = sourceFilter;  src = ./crates/andro-gos; };
        libName = "andro_gos";
        authors = [
          "pleme-io"
        ];
      ...
      "andro-health" = rec {
        crateName = "andro-health";
        version = "0.1.0";
        edition = "2024";
        src = lib.cleanSourceWith { filter = sourceFilter;  src = ./crates/andro-health; };
        libName = "andro_health";
        authors = [
          "pleme-io"
        ];
        dependencies = [
      ...
      "andro-hw" = rec {
        ...
        version = "0.1.0";
        edition = "2024";
        src = lib.cleanSourceWith { filter = sourceFilter;  src = ./crates/andro-hw; };
        libName = "andro_hw";
        authors = [
          "pleme-io"
        ];
      ...
      "andro-log" = rec {
        ...
        version = "0.1.0";
        edition = "2024";
        src = lib.cleanSourceWith { filter = sourceFilter;  src = ./crates/andro-log; };
        libName = "andro_log";
        authors = [
          "pleme-io"
        ];
      ...
      "andro-manifest" = rec {
        crateName = "andro-manifest";
        version = "0.1.0";
        edition = "2024";
        src = lib.cleanSourceWith { filter = sourceFilter;  src = ./crates/andro-manifest; };
        libName = "andro_manifest";
        authors = [
          "pleme-io"
        ];
        dependencies = [
      ...
      "andro-sec" = rec {
        ...
        version = "0.1.0";
        edition = "2024";
        src = lib.cleanSourceWith { filter = sourceFilter;  src = ./crates/andro-sec; };
        libName = "andro_sec";
        authors = [
          "pleme-io"
        ];
      ...
      "andro-settings" = rec {
        crateName = "andro-settings";
        version = "0.1.0";
        edition = "2024";
        src = lib.cleanSourceWith { filter = sourceFilter;  src = ./crates/andro-settings; };
        libName = "andro_settings";
        authors = [
          "pleme-io"
        ];
        dependencies = [
      ...
      "andro-sign" = rec {
        crateName = "andro-sign";
        version = "0.1.0";
        edition = "2024";
        src = lib.cleanSourceWith { filter = sourceFilter;  src = ./crates/andro-sign; };
        libName = "andro_sign";
        authors = [
          "pleme-io"
        ];
      ...
      "andro-sync" = rec {
        crateName = "andro-sync";
        version = "0.1.0";
        edition = "2024";
        src = lib.cleanSourceWith { filter = sourceFilter;  src = ./crates/andro-sync; };
        libName = "andro_sync";
        authors = [
          "pleme-io"
        ];
      ...
      "blake3" = rec {
        ...
        dependencies = [
          ...
          }
          {
            ...
            packageId = "constant_time_eq 0.4.2";
            usesDefaultFeatures = false;
          }
          {
            name = "cpufeatures";
      ...
      "fudajiku" = rec {
        ...
        src = pkgs.fetchgit {
          url = "https://github.com/pleme-io/fudajiku";
          rev = "41df9ad52af505e0890598d3b9820c865f1ec9c3";
          sha256 = "0dlvbx0yhsz7c12avbvdvnjql4y575phnlyzzvy0d7ks13cb1y7s";
        };
        dependencies = [
          {
            name = "blake3";
